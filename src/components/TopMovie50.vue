...
export default {
  ...
  methods: {
    ...
    getMovies(component) {
      axios
        .get(
          "https://api.themoviedb.org/3/discover/movie?api_key=f39312b1a257a589a68b7feed39d29c8&language=fr&sort_by=vote_count.desc&include_adult=false&include_video=false&page=1"
        )
        .then(function (response) {
          ...
          axios
            .get(
              "https://api.themoviedb.org/3/discover/movie?api_key=f39312b1a257a589a68b7feed39d29c8&language=fr&sort_by=vote_count.desc&include_adult=false&include_video=false&page=2"
            )
